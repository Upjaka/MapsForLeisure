...
public class ListRoutesAdapter extends ArrayAdapter<ListItem> {
    public ListRoutesAdapter(Context context, List<ListItem> itemList) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (item != null) {
            ...
            // Обработчики кнопок
            holder.imageButton1.setOnClickListener(v -> ((MainActivity) getContext()).onRouteListDeleteButtonClick(position));
            holder.imageButton2.setOnClickListener(v -> ((MainActivity) getContext()).onRouteListSetVisibleButtonClick(position));
        }
