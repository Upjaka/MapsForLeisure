...
public class ListTracksAdapter extends ArrayAdapter<ListItem> {
    public ListTracksAdapter(Context context, List<ListItem> itemList) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (item != null) {
            ...
            // Обработчики кнопок
            holder.imageButton1.setOnClickListener(v -> ((MainActivity) getContext()).onTrackListDeleteButtonClick(position));
            holder.imageButton2.setOnClickListener(v -> ((MainActivity) getContext()).onTrackListSetVisibleButtonClick(position));
        }
